...
from .views import (CreateProduct, ProductDetail, UpdateProduct, DeleteProduct,ProductImageForm)
...
urlpatterns = [
    ...
    path('image/edit/<int:pk>',DeleteProductImage.as_view(),name='del_prod_image')
]